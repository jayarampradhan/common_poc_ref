...
*/	
	...
	@Test
	public void decodeToListOfStringTest1(){
		String s= "hello, welcome to uimirror";
		System.out.println(CollectionUtils.decodeToListOfString(s, "Lst Not Valid"));
		Assert.assertNotNull(CollectionUtils.decodeToListOfString(s, "Lst Not Valid"));
	}
	@Test
	...
	@Test
	public void decodeToListOfStringTest2(){
		String s= "hello, welcome to uimirror";
		System.out.println(CollectionUtils.decodeToListOfString(s));
		Assert.assertNotNull(CollectionUtils.decodeToListOfString(s));
	}
	...
	/*@Test
	@SuppressWarnings("unchecked")
	public void convertAllMultiToSomeSingelTest(){
		...
		try{
			Assert.assertNotNull(CollectionUtils.convertAllMultiToSomeSingel(map1));
		}catch(Exception e){
			Assert.fail(e.getMessage());
		}
