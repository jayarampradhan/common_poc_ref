package com.uimirror.common.exception;
...
public class CommonSystemException extends Exception {
     ...
     */
    public CommonSystemException(String errMsg) {
	super(errMsg);
	this.exception = null;
    }
     ...
     */
    public CommonSystemException(String errMsg, int errCode) {
	super(errMsg);
     ...
     *            custom error code
     */
    public CommonSystemException(int errCode) {
	this.errCode = errCode;
	this.exception = null;
    }
     ...
     */
    public CommonSystemException(String errMsg, Exception paramException) {
	super(errMsg);
     ...
     * @param paramException
     */
    public CommonSystemException(Exception paramException) {
	this.exception = paramException;
    }
