...
/**
 * <p>
 * This is a utility class which will do encrypt or decrypt using
 * 
 * @author Jayaram
 * @version 1.0
 * 
...
public class Encryptor {
	...
	if (args.length == 1 || args.length == 2 || args.length == 3) {
	    ...
	    String encryptedString = aes.encrypt(plainText);//default
	    System.out.println(plainText + " encrypted :" + encryptedString);
	    //System.out.println(plainText + "decrypted :" + aes.decrypt(encryptedString));
